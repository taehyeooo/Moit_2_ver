...
> 교내 학술제 금상 수상작(v1.0)을 포트폴리오 수준으로 고도화한 풀스택 프로젝트입니다.
...
사용자 요청 (Frontend)
  ...
  └── POST /agent/invoke
    ...
    │                       │
설문 데이터 포함          그 외 요청
(룰 기반, LLM 미호출)   (GPT-4o-mini 분기)
    │                       │
    ▼                       ▼
[Hobby Agent]        [Search Agent]
 설문 49문항          Pinecone RAG
 5차원 프로파일링     + Tavily 실시간 검색
    │                       │
    ▼                       ▼
...
> v1.0 해커톤 코드 기준으로 2회에 걸쳐 유지보수를 진행했습니다.
...
> **기간**: v1.0 직후 · **목적**: 해커톤 코드의 즉각적인 성능 문제 및 버그 해소
