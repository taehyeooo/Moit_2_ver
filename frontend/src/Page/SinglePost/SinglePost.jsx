...
const SinglePost = () => {
  ...
  if (!post) {
    return (
        <Container maxWidth="lg" sx={{ py: 14 }}>
            <StyledPaper elevation={2}>
                <Typography variant="h5" align="center">게시글을 찾을 수 없습니다.</Typography>
            </StyledPaper>
        </Container>
    )
  }
      ...
      <StyledPaper elevation={2}>
        ...
        <Box sx={{ my: 4 }}>
          <div
            ...
            style={{ lineHeight: 1.8, fontSize: '1.1rem', wordBreak: 'break-all' }}
          />
        </Box>
          ...
          <Box sx={{ mt: 4, p: 2, bgcolor: "grey.50", borderRadius: 1 }}>
            ...
            <Box sx={{ display: "flex", gap: 1, flexWrap: "wrap" }}>
              {post.fileUrl.map((file, index) => (
                <Chip
                  key={index}
                  label={decodeURIComponent(file.split("/").pop())}
                  variant="outlined"
                  clickable
